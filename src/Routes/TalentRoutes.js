      ...
      >
        ...
        <div>
          <Routes>
            ...
            <Route path="/find-work" exact element={<HomeTalent/>} />
            ...
            />
            <Route path="/job/applied/:id" exact element={<JobAppliedDetails/>} />
            <Route path="/saved-jobs" exact element={<SavedJobs/>} />
            ...
            <Route path="/all-contract" exact element={<AllContracts/>} />
            ...
            <Route path="/life-time-billing" exact element={<BillingByClients/>} />
            <Route path="/connects-history" exact element={<ConnectsHistory/>} />
            <Route path="/buyconnects" exact element={<BuyConnects/>} />
            {/* <Route
